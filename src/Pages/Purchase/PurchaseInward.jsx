         ...
         <header className="bg-white shadow">
          <div className="mx-auto max-w-7xl px-4  sm:px-6 lg:px-8">
            <div className="flex justify-between py-4 items-center">
              <h1 className="text-3xl font-bold tracking-tight">{navbarTitle.purchase + ' ' + navbarTitle.inward}</h1>
              <Button onClick={() => setOpen(true)}>{navbarTitle.purchase + " " + loginConst.form}</Button>
            </div>
          </div>
        </header>
